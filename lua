...
local whitelistname = {'I2xIV', '17kLorys', 'EFE4424GS', 'dragcibabapiro', 'Immo7d', 'tpsibo_ydk', 'Zzz_tps2', 'OpsPanterJr', 'Cleitingrauzudo157', 'izlro', 'simitistan25', 'Abzzy_4lt', 'KUZEY_BT',} -- has strings ('',"") and in the strings u put the names
