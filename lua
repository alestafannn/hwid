...
local whitelistname = {'I2xIV', '17kLorys', 'EFE4424GS', 'dragcibabapiro', 'Immo7d', 'tpsibo_ydk', 'Zzz_tps2', 'OpsPanterJr', 'Cleitingrauzudo157', 'BarisKavak2', 'Abzzy_4lt',} -- has strings ('',"") and in the strings u put the names
