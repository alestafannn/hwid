...
local whitelistname   = {'bluvkynaltaccount', 'bigturae', 'ALMUTASIMq', 'Alexnimo2022', 'YTBR_DEOPBULL1', 'rx_mamxi', 'dilaver7115', 'eksisjssjhs',} -- has strings ('',"") and in the strings u put the names
